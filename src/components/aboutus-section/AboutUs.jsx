...
const AboutUs = () => {
  return (
    <section className="mx-48 flex flex-col gap-24" id="about">
      ...
      <div className="flex flex-row gap-16 place-items-center">
        <p className="w-1/2 text-white text-2xl leading-normal text-justify font-mono">
        ...
        <img src={TEAM} className="flex-1" alt="img" />
      </div>
    </section>
  );
};
