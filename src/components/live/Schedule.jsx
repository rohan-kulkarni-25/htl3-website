...
const schedule = [
  ...
  { event: "Mentoring Round 1 Starts", timestamp: new Date(day1StartTime).setHours(14, 0) },
  { event: "Mentoring Round 1 Ends", timestamp: new Date(day1StartTime).setHours(15, 0) },
  { event: "Polygon", timestamp: new Date(day1StartTime).setHours(15, 0) },
