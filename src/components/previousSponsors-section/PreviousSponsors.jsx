...
const PreviousSponsors = () => {
  return (
    <section className=" flex flex-col gap-24">
      <div className="flex flex-row gap-7 mx-48 place-items-center ">
      ...
      <div className="flex flex-wrap justify-evenly items-center p-8 bg-white rounded-lg bg-opacity-20 backdrop-filter backdrop-blur-lg mx-48 ">
        <div className="flex-none w-32  mr-8 ">
